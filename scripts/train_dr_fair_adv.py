...
def train(model, criterion, optimizer, scaler, adv_model, adv_criterion, adv_optimizer,
          train_dataset_loader, epoch, total_iteration, dataset_info=None, num_classes=2, args=None):
    global device
